            ...
            this.shadowRoot.innerHTML = `
                <style>
                    section {
                        ...
                        border-radius: 10px;
                        padding: 15px; /* Eliminamos el padding de la sección */
                    ...
                    .my-tweets {
                        display: flex;
                        flex-direction: column;
                        gap: 15px; /* Añadimos espacio entre los elementos */
                    ...
                    button {
                        ...
                        margin-top: 15px; /* Separación con el contenido anterior dentro de la sección */
